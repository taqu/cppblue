# Introduction
## Blue noise sample generation
Generate tiled samples based on [Weighted Linde-Buzo-Gray Stippling](https://graphics.uni-konstanz.de/publikationen/Deussen2017LindeBuzoGray/index.html)
## Blue noise texture generation
Generate 1D, 2D and 3D image based on [The void-and-cluster method for dither array generation](http://cv.ulichney.com/papers/1993-void-cluster.pdf)
